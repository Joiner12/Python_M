...
class SecondWindow(QWidget):
    ...
    def setupUi(self, Form):
        ...
        self.p = QPalette()
        self.pixmap = QPixmap(r"D:\Codes\Python_M\Code\PyTick\Src\Background-2.jpg").scaled(
    ...
    def resizeEvent(self, ResizeEvent):
        size = self.size()
        self.p.setBrush(QPalette.Background, QBrush(self.pixmap.scaled(
